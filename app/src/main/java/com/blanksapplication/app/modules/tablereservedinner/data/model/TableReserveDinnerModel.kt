package com.blanksapplication.app.modules.tablereservedinner.`data`.model

import com.blanksapplication.app.R
import com.blanksapplication.app.appcomponents.di.MyApp
import kotlin.String

data class TableReserveDinnerModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTimeFrame: String? = MyApp.getInstance().resources.getString(R.string.lbl_1800_1900)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTimeFrameOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_1900_2000)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTimeFrameTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_2000_2100)
